...
<body>
    <div class="container-fluid">
        <div class="row">
           ...
           include "./nav.php";
           ?>
            <h1 class="text-center mt-5"  style="font-family: 'Times New Roman', Times, serif; color: maroon;">VIEW HIT SONGS</h1>
                    ...
                    <?php
                        ...
                        foreach($result as $row){
                            ...
                            <tr>
                                ...
                                <td><a href="./deletehit.php? <?php echo "id=$row[id]"?> " class="btn btn-danger">Delete</a></td>
                            </tr>
                    <?php 
                      }
                      ?>
