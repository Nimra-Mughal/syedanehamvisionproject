...
if(isset($_POST['addhitsong'])){
  ...
  $tmpname=$_FILES['image']['tmp_name'];
    ...
    $sql="INSERT INTO `hit`(`name`, `desc`,`image`,`song`) VALUES ('$songname','$desc','$img_url','$audio_url')";
        ...
        <div class="row">
           ...
           ?>
                <h1 class="text-center mt-5" style="font-family: 'Times New Roman', Times, serif; color: maroon;">ADD SONGS</h1>
                        <form action="./addhitsong.php" method="post" enctype="multipart/form-data" class="w-75 p-5 bg-light mx-auto">
                            ...
                            <input type="file" name="song" id="" class="form-control mt-2" placeholder="imgupload">
                            <input type="file" name="image" id="" class="form-control mt-2" placeholder="songupload">
                            <input type="submit" name="addhitsong" class=" mt-3 btn btn-dark rounded-pill px-5 offset-5">
