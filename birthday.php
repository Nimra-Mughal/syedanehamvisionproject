...
<body>
    ...
    <section class="breadcumb-area bg-img bg-overlay" style="background-image: url(img/core-img/bb.jpg);">
        <div class="bradcumbContent">
            <p>See what’s new</p>
            <h2>BIRTHDAY SONGS</h2>
        </div>
    </section>
    <!-- ##### Breadcumb Area End ##### -->
    ...
    <!-- ##### Song Area Start ##### -->
    <div class="one-music-songs-area mb-70" style="margin-top: 10%">
        <div class="container">
            <div class="row">

                <!-- Single Song Area -->
                <?php
                $sql = "SELECT * FROM `arijit singh` WHERE singername = 'BIRTHDAY'";
