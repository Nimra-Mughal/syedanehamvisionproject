        ...
        <div class="modal-dialog">
            <div class="modal-content" id="md">
                ...
                <div class="modal-body">
                    ...
                    <h6 class="text-center text-light mt-2" style="font-family: 'Times New Roman', Times, serif;">click here glow <br><i class="fa-solid fa-arrow-down text-primary mt-2"></i>
                    </h6>
                    <a href="./login.php" class="btn text-light mx-auto d-block w-25" style="background-color:rgba(198, 3, 3, 0.8);">LOGIN</a>
