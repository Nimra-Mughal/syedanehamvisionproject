...
<body>
    ...
    <div class="one-music-songs-area mb-70" style="margin-top: 15%">
        <div class="container">
            <div class="row">
                ...
                <!-- Single Song Area -->
                <?php
                $sql = "SELECT * FROM `arijit singh` WHERE singername = 'Rahat Fateh Ali Khan'";
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="background-color: black;   box-shadow: 15px -15px 15px rgb(16, 16, 16),
           inset 15px -25px 15px rgb(0, 0, 0);">
            ...
            <div class="modal-body">
                ...
                <h4 class="text-center text-light mt-2" style="font-family: 'Times New Roman', Times, serif;">Login in Please</h4>
                <button type="button" href="./login.php" class="btn btn-danger offset-5" data-bs-dismiss="modal">LOGIN</button>
