                      ...
                      <div class="single-event-area mb-30">
                        ...
                        <div class="event-text">
                            ...
                            <div class="event-meta-data">
                                <a href="#" class="event-place"><?php echo $row['name']?></a>
                                <a href="#" class="event-date"><?php echo $row['desc']?></a>
                            </div>
                            <a href="#" class="btn see-more-btn"><?php echo $row['address']?></a><br>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="load-more-btn text-center mt-70">
                        <a href="./index.php" class="btn oneMusic-btn">Home <i class="fa fa-angle-double-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
